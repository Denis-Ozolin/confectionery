      ...
      <div className="cooperation__container">
        ...
        <div className="cooperation__body">
          ...
          <div className="cooperation__content">
            ...
            <p className="cooperation__text">
              Ми  працюємо тільки з натуральними інгредієнтами, Не
              використовуємо консерванти, ароматизатори та не збільшуємо штучно
              термін придатності десертів.
            </p>
            <p className="cooperation__text">
            ...
            <p className="cooperation__text">
              Ви отримаєте доступ до нашого сайту, як партнер, зможете
              оформлювати замовлення через кошик та бачити спеціальні ціни, які
              ми пропонуємо для співпраці.
            </p>
            <p className="cooperation__text">
