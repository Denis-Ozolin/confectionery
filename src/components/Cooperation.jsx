      ...
      <div className='cooperation__container'>
        ...
        <div className='cooperation__body'>
          ...
          <div className='cooperation__content'>
            ...
            <p className='cooperation__text'>Ми  працюємо тільки з натуральними інгредієнтами, Не використовуємо консерванти, ароматизатори та не збільшуємо штучно термін придатності десертів.
            <p className='cooperation__text'>Надаємо великий вибір нашим партнерам, оновлюємо асортимент, підтримуємо різноманітність.</p></p>
